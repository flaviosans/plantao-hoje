                        ...
                        <ul class="nav navbar-nav pull-right panel-menu">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="/admin/profile" class="ajax-link">
    ...
    <div class="row">
        <div id="sidebar-left" class="col-xs-2 col-sm-2">
            <ul class="nav main-menu">
                <li>
                    <a href="/admin/dashboard" class="active ajax-link">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle">
                        <i class="fa fa-usd"></i>
                        <span class="hidden-xs">Vender</span>
                    </a>
                    <ul class="dropdown-menu">
                        <li><a class="ajax-link" href="/admin/campanhas">Campanhas</a> </li>
                    </ul>
                </li>
