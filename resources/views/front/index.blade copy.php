...
@section('content')
            ...
            <div class="grid_3 grid_5">
                <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                    <ul id="myTab" class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#expeditions" id="expeditions-tab" role="tab" data-toggle="tab" aria-controls="expeditions" aria-expanded="true">Itens em Destaque</a></li>
                        <li role="presentation"><a href="#tours" role="tab" id="tours-tab" data-toggle="tab" aria-controls="tours">Últimas Itens:</a></li>
                    </ul>
                    <div id="myTabContent" class="tab-content">
                                                    ...
                                                    <div class="snipcart-item block" >
                                                        <div class="snipcart-thumb">
                                                            <a href="products.html">
                                                                <img src="{{$item->produto->imagem()->first()->caminho or 'images/placeholder.png'}}" alt="" width="150" height="150">
                                                            </a>
                                                            ...
                                                            <h4>{{$item->preco}} <span>{{$item->preco}}</span></h4>
                                                        </div>
                                                        <div class="snipcart-details top_brand_home_details">
                                                            <form action="#" method="post">
                                                                <fieldset>
                                                                    ...
                                                                    <input type="hidden" name="item_name" value="{{$item->produto->nome}}" />
                                                                    <input type="hidden" name="amount" value="{{$item->preco}}" />
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tours" aria-labelledby="tours-tab">
                            <div class="agile-tp">
                                <h5>Últimos Itens</h5>
                                <p class="w3l-ad">Essas itens acabaram de chegar no nosso site! Legal, não?</p>
                            </div>
                            <div class="agile_top_brands_grids">
                                @foreach($itens as $item)
                                    <div class="col-md-4 top_brand_left">
    ...
    <div class="newproducts-w3agile">
        <div class="container">
            <h3>Últimas Itens Cadastradas:</h3>
            <div class="agile_top_brands_grids">
                @foreach($itens as $item)
                    <div class="col-md-4 top_brand_left">
                        <div class="hover14 column">
                                ...
                                <div class="agile_top_brand_left_grid1">
                                    <figure>
                                        <div class="snipcart-item block" >
                                            <div class="snipcart-thumb">
                                                <a href="products.html">
                                                    @if($item->produto->imagem()->first() != null)
                                                        <img src="{{$item->produto->imagem()->first()->caminho}}" alt="" width="150" height="150">
                                                    @endif
                                                </a>
                                                <p>{{$item->produto->nome}}</p>
                                                <div class="stars">
